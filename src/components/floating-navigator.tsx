...
const buttonBase =
  "w-12 h-12 rounded-full flex items-center justify-center shadow-xl shadow-black/25 transition-all duration-200 border border-white/10 backdrop-blur pointer-events-auto"
