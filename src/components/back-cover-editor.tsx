  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        <h2 className="text-2xl font-bold font-serif">Diseña tu Contraportada</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Crea una contraportada profesional con información del libro, 
          reseñas y elementos de diseño que complementen tu portada.
        </p>
      </div>
                  ...
                  <div className="space-y-3">
                    {backCoverData.publisher && (
                      <div>
                        ...
                        <p className="text-sm opacity-90">{backCoverData.publisher}</p>
                      </div>
                    )}
                    ...
                    {backCoverData.isbn && (
                      <div>
                        ...
                        <p className="text-sm opacity-90">{backCoverData.isbn}</p>
                      </div>
                    )}
            ...
            <CardContent className="p-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">{backCoverData.title || "Sin título"}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Autor:</span>
                  <span className="text-sm font-medium">{backCoverData.author || "Sin autor"}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Editorial:</span>
                  <span className="text-sm font-medium">{backCoverData.publisher || "Sin editorial"}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">ISBN:</span>
                  <span className="text-sm font-medium">{backCoverData.isbn || "Sin ISBN"}</span>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDataChange("publisher", e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDataChange("isbn", e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleDataChange("publicationDate", e.target.value)}
                      className="surface-1"
                    />
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  {reviews.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm">Añade reseñas críticas para mejorar la presentación</p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      {reviews.map((review, index) => (
                        <div key={review.id} className="p-4 border rounded-lg surface-1">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                            <div className="space-y-2">
                              <Label htmlFor={`review-author-${index}`}>Autor de la reseña</Label>
                              <Input
                            ...
                            <div className="space-y-2">
                              <Label htmlFor={`review-source-${index}`}>Fuente</Label>
                              <Input
                    ...
                    <div className="border-2 border-dashed border-border rounded-lg p-8 text-center hover:border-primary/50 transition-colors">
                      ...
                      <div className="space-y-4">
                        ...
                        <Button 
                          variant="outline" 
                          size="sm" 
                          onClick={() => document.getElementById('back-cover-image')?.click()}
                        >
